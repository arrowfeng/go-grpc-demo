...
var fileDescriptor_17b8c58d586b62f2 = []byte{
	...
	0x42, 0x12, 0x5c, 0xec, 0xb9, 0xa9, 0xc5, 0xc5, 0x89, 0xe9, 0x30, 0x75, 0x30, 0xae, 0x91, 0x3b,
	0x17, 0x17, 0x58, 0x69, 0x38, 0xc8, 0x2e, 0x21, 0x4b, 0x2e, 0x8e, 0xe0, 0xc4, 0x4a, 0xb0, 0x80,
	0x90, 0xa8, 0x1e, 0xd4, 0x4a, 0x3d, 0x64, 0xfb, 0xa4, 0xc4, 0xd0, 0x85, 0x21, 0x56, 0x24, 0xb1,
	0x81, 0xdd, 0x69, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x97, 0xf9, 0xe7, 0xbe, 0xbb, 0x00, 0x00,
	0x00,
}
...
func (c *helloWorldClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/service.HelloWorld/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _HelloWorld_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service.HelloWorld/SayHello",
	}
